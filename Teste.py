...
with st.form(key='infos'):
    st.markdown('''**:blue[Preencha esse formulário de acordo com as características do seu cabelo]**''')
    ...
    # Lista de linhas com suas descrições e imagens
    linhas = [
        {"nome": "Scalp Advanced", "desc": "Cuidados avançados para o couro cabeludo, combatendo problemas como caspa e oleosidade."},
        {"nome": "Absolut Repair Molecular", "desc": "Ideal para todos os tipos de cabelo danificados: Garante reconstrução, cabelos mais fortes e nutridos."},
        {"nome": "Metal Detox", "desc": "Proteção contra poluentes e impurezas."},
        {"nome": "Curl Expression", "desc": "Cuidados especiais para cabelos cacheados, proporcionando definição e controle de frizz."},
        {"nome": "Absolut Repair", "desc": "Reparação e nutrição para cabelos danificados, restaurando a saúde e o brilho."},
        {"nome": "Choma Creme", "desc": "Tratamento para cabelos coloridos, protegendo a cor e prolongando a intensidade."},
        {"nome": "Fluidfier", "desc": "Controle de frizz e definição de cabelos lisos."},
        {"nome": "Pro Longer", "desc": "Cuidados para cabelos mais longos, fortalecendo e protegendo as pontas."},
        {"nome": "Blondifier", "desc": "Cuidados específicos para cabelos loiros, neutralizando tons amarelados e proporcionando brilho."},
        {"nome": "Inforce", "desc": "Fortalecimento e reconstrução para cabelos enfraquecidos e quebradiços."},
        {"nome": "Nutrifier", "desc": "Nutrição intensa para cabelos secos e desidratados."},
    ]
    
    for linha in linhas:
        col1, col2 = st.columns([1, 5])
        with col1:
            st.image("Linhassite .jpg", width=80)  # Ajuste o tamanho conforme necessário
        with col2:
            st.markdown(f'**:grey[{linha["nome"]}:]** {linha["desc"]}')
    
    linha = st.radio("Escolha a linha que você quer ver o resultado no seu cabelo", [l["nome"] for l in linhas])
